...
// and only updated with setState().const element = <h1>React elements</h1>;
...
// Handling Multiple Inputs, add a name attribute
...
export function Forms() {
  return (
    <>
      ...
      the user from changing the input unless you desire so.  */}
      <input value="" readOnly />
      <input value="hi" onChange={v => console.log(v)} />
